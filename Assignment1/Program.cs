...
namespace Assignment1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            const string VesselName = "KRNX";

            // 2. var (camelCase) - ใช้กับ string และ char รวมกัน 2 ตัว
            var pilotCallsign = "Ken";      // var บน string
            var engineClass = "TurboS";                 // var บน char
            ...
            int warpLevel = 9;
            float shieldPercentage = 0.65f;
            double fuelCellLevel = 43.8;          // เลือกเลขหลังจุดเป็น .8 เพื่อให้ผลปัดเศษต่างกัน
            bool hyperdriveReady = true;

            Console.WriteLine($"//=======================================\\");
            Console.WriteLine($"|              VESTX STATUS              |");
            Console.WriteLine($"|----------------------------------------|");
            ...
            Console.WriteLine($"[LOG] Warp Level (Explicit Double): {Convert.ToDouble(warpLevel)}");
